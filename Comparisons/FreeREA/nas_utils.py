...
def clean_history(history, max_params, max_flops): # DEFINE THE CONSTRAINTS HERE
    return {genotype: exemplar for genotype, exemplar in history.items()
            if exemplar.get_cost_info()['params'] <= max_params    # max params and max flops are pre-defined values
