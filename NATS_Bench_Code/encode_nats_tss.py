...
# TEMPORARILY SEPARATED SSS and TSS FILES TO RUN CONCURRENTLY. RENAME AS encode_nats.py
...
for api_source in ['tss']:
    ...
    for dataset in ['cifar100', 'ImageNet16-120']: # Correct it to include cifar10
